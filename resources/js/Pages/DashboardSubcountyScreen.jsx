...
function DashboardSubcountyScreen({ subcounties, districts }) {
    ...
    const columns = [
        ...
        {
            name: 'County',
            selector: row => row.county.county,
        },
        {
            name: 'District',
            selector: row => row.county.district.district,
        },
                            ...
                            <div className="space-y-4 w-full">
                                ...
                                <div className="mb-4">
                                    ...
                                    <Select
                                        ...
                                        onChange={(option) => setData('county', option?.value || '')}
...
DashboardSubcountyScreen.layout = page => <Layout children={page} />

export default DashboardSubcountyScreen