...
function OccupationsScreen({occupations}) {
    const { data, setData, processing, post, reset, errors } = useForm();
        const [search, setSearch] = useState('');
        console.log(occupations)
        const [page, setPage] = useState(1);
        const fetchData = (page) => {
            router.get(`/dashboard/occupation`, { page, search }, { preserveState: true });
        };
        ...
        const handleSearch = e => {
            ...
            router.get(`/dashboard/occupation`, {
                search, page: 1
            }, {
        ...
        const handleSubmit = async (event) => {
            ...
            post('/dashboard/occupation/post', {
        ...
        function editTheOccupation( occupation) {
            handleOpenEdit("xl")
        ...
        const columns = [
            ...
            {
                selector: row => <button onClick={() => editTheOccupation(row.occupation, row.id)} className='bg-green-600 rounded-md p-1'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="white" className="w-5 h-5">
  ...
  return (
    <div>
            <DataTable
                ...
                pagination
                paginationServer
                paginationTotalRows={occupations.total}
                paginationPerPage={occupations.per_page}
                    ...
                    >
                       ...
                       <path strokeLinecap="round" strokeLinejoin="round" d="M15.182 15.182a4.5 4.5 0 01-6.364 0M21 12a9 9 0 11-18 0 9 9 0 0118 0zM9.75 9.75c0 .414-.168.75-.375.75S9 10.164 9 9.75 9.168 9 9.375 9s.375.336.375.75zm-.375 0h.008v.015h-.008V9.75zm5.625 0c0 .414-.168.75-.375.75s-.375-.336-.375-.75.168-.75.375-.75.375.336.375.75zm-.375 0h.008v.015h-.008V9.75z" />
                            ...
                            <Input label='Occupation'
                                value={data.occupation ?? ''} onChange={e => setData('occupation', e.target.value)} size='sm'
                            />
                            ...
                            >
                                ...
                                >
                                    <DialogBody divider className="grid place-items-center gap-4">
                                        ...
                                        <Input color='deep-orange' label='Occupation' 
                                            value={editOccupation} onChange={(event) => setEditOccupation(event.target.value)} size='sm'
                                        />
...
OccupationsScreen.layout = (page) => <Layout children={page} />;
